...
function extractProductsFromHtml(html, defaultCategory, storeId, queryName) {
  ...
  for (const item of altItems) {
    ...
    if (!link || !link.startsWith("http") || link.includes("javascript:")) {
      link = buildEbaySearchUrl(queryName || name, country);
    }
  ...
  "ebay-de": [
    {
      ...
      category: "Toys",
      source: "ebay-de",
      url: buildEbaySearchUrl("Pokemon PKM Tin 131", "DE"),
    ...
    },
    {
      ...
      source: "ebay-de",
      url: buildEbaySearchUrl("Wago Compact Connection Clamps", "DE"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-de",
      url: buildEbaySearchUrl("DeLonghi EcoDecalk DLSC500 500ml", "DE"),
    ...
    },
    {
      ...
      category: "Home & Garden",
      source: "ebay-de",
      url: buildEbaySearchUrl("fischer DuoPower 6 x 30 Universal Dowels", "DE"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-de",
      url: buildEbaySearchUrl("Siemens Descaling Tablets TZ80002A", "DE"),
  ...
  "ebay-fr": [
    {
      ...
      category: "Toys",
      source: "ebay-fr",
      url: buildEbaySearchUrl("Pokemon Boite Mega Puissances Darkrai", "FR"),
    ...
    },
    {
      ...
      category: "Toys",
      source: "ebay-fr",
      url: buildEbaySearchUrl("LEGO Botanicals 10349 Small Smiling Plants", "FR"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-fr",
      url: buildEbaySearchUrl("DeLonghi EcoDecalk DLSC500 500ml", "FR"),
    ...
    },
    {
      ...
      category: "Toys",
      source: "ebay-fr",
      url: buildEbaySearchUrl("Magilano SKYJO Card Game", "FR"),
  ...
  "ebay-it": [
    {
      ...
      category: "Kitchen",
      source: "ebay-it",
      url: buildEbaySearchUrl("Pritt Glue Stick 6x22g", "IT"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-it",
      url: buildEbaySearchUrl("DeLonghi EcoDecalk DLSC500 500ml", "IT"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-it",
      url: buildEbaySearchUrl("DeLonghi DLSC002 Water Filter", "IT"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-it",
      url: buildEbaySearchUrl("LAICA Bi Flux 6 Water Filters", "IT"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-it",
      url: buildEbaySearchUrl("Foppapedretti La Cover", "IT"),
  ...
  "ebay-es": [
    {
      ...
      category: "Kitchen",
      source: "ebay-es",
      url: buildEbaySearchUrl("Amazon Basics Velvet Hangers 50", "ES"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-es",
      url: buildEbaySearchUrl("Digital Kitchen Scale LCD", "ES"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-es",
      url: buildEbaySearchUrl("BRITA MAXTRA PRO Pure Performance 6 Pack", "ES"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-es",
      url: buildEbaySearchUrl("Pritt Original Glue Stick", "ES"),
  ...
  "ebay-uk": [
    {
      ...
      source: "ebay-uk",
      url: buildEbaySearchUrl("DURACELL Plus AAA Alkaline Batteries 24 Pack", "UK"),
    ...
    },
    {
      ...
      category: "Electronics",
      source: "ebay-uk",
      url: buildEbaySearchUrl("DURACELL 2032 Lithium Coin 4 Pack", "UK"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-uk",
      url: buildEbaySearchUrl("Amazon Basics Slim Velvet Hangers 30", "UK"),
    ...
    },
    {
      ...
      category: "Kitchen",
      source: "ebay-uk",
      url: buildEbaySearchUrl("DeLonghi EcoDecalk 500ml", "UK"),
    ...
    },
    {
      ...
      category: "Electronics",
      source: "ebay-uk",
      url: buildEbaySearchUrl("PERLESMITH TV Wall Bracket 26 70", "UK"),
